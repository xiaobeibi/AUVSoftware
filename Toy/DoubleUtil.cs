...
namespace AUVSoftware.Toy
{
    public class DoubleUtil
    {
        ...
        {
            return DoubleUtil.AreClose(thick.Left, thick.Top)
                    && DoubleUtil.AreClose(thick.Left, thick.Right)
                    && DoubleUtil.AreClose(thick.Left, thick.Bottom);
        }

        public static bool IsZero(Thickness thick)
        {
            return DoubleUtil.IsZero(thick.Left)
                    && DoubleUtil.IsZero(thick.Top)
                    && DoubleUtil.IsZero(thick.Right)
                    && DoubleUtil.IsZero(thick.Bottom);
        }
